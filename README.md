...
## Local Planet Zoo Pipeline

This private working copy includes local Planet Zoo extraction and preprocessing
notes under `docs/PLANETZOO_ANYTOP_PIPELINE.md`, plus helper scripts under
`tools/planetzoo/`. These additions adapt the official new-skeleton pipeline to
...
(b) Place the Truebone_Z-OO directory inside our repository under ./dataset/truebones/zoo/
